...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($recipe_image)) {
        ...
        $sql = "UPDATE recipes SET recipe_name = '$recipe_name', description = '$description', ingredients = '$ingredient_list', instructions = '$instructions', recipie_image = '$new_filename' WHERE recipie_id = $recipe_id";
    } else {
        $sql = "UPDATE recipes SET recipe_name = '$recipe_name', description = '$description', ingredients = '$ingredient_list', instructions = '$instructions' WHERE recipie_id = $recipe_id";
    }
