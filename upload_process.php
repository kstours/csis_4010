...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO recipes (upload_username, recipe_name, description, ingredients, instructions, recipie_image) VALUES ('$username', '$recipe_name', '$description', '$ingredient_list', '$instructions', '$new_filename')";
